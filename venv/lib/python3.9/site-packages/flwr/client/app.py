    ...
    while True:
        ...
        with connection(
            ...
            while True:
                ...
                # try:
                #     status_dict[client_id] = serde.server_message_from_proto(server_message).fit_ins.config
                # except:
                #     pass
                ...
                time.sleep(time_delay)
                try:
                    status_dict[client_id] = serde.client_message_from_proto(client_message).fit_res.status.message
                except:
                    pass
