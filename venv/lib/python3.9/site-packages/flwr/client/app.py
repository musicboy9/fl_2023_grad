...
import flwr.common.serde as serde
        ...
        with connection(
            ...
            while True:
                ...
                if 'fit_res' in str(client_message):
                    ...
                    status_dict[ client_id, status_dict[ ROUND ], TRAIN, "msg" ] = client_message
                elif 'evaluate_res' in str(client_message):
                    result_type = "evaluating"
                    status_dict[ client_id, status_dict[ ROUND ], EVAL, "msg" ] = client_message

                if result_type != "":
                    status_dict[ LOG ] += f"{date.now_custom()}, round {status_dict[ ROUND ]}: client {client_id} {result_type} result sent to server\n"
