    ...
    while True:
        ...
        with connection(
            ...
            while True:
                ...
                try:
                    status_dict[(client_id, "get_msg")] = serde.server_message_from_proto(server_message).fit_ins.config
                except:
                    pass
                ...
                time.sleep(time_delay)
                try:
                    status_dict[client_id, "send_msg"] = client_message
                    # status_dict[client_id, "send_msg"] = serde.client_message_from_proto(client_message)
                except:
                    pass
                send(client_message)
